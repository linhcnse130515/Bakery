            ...
            <div class="row">
                ...
                <div class="menu-cat mx-auto">
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="pills-cake-tab" data-toggle="pill" href="#pills-cake" role="tab" aria-controls="pills-cake" aria-selected="false">Cake</a> </li>
                    </ul>
                </div>
            ...
            <div id="pills-tabContent" class="tab-content absolute">
                ...
                <div class="tab-pane fade" id="pills-cookie" role="tabpanel" aria-labelledby="pills-cookie-tab">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:BakeryConnectionString %>" SelectCommand="SELECT [ProId], [ProName], [Price], [Status], [ImgUrl], [Description], [Quantity] FROM [Product] WHERE ([CategoryId] = @CategoryId) AND ([Status] = 'Available')">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="Cookie" Name="CategoryId" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </div>
                <%--Cake Tab--%>
                <div class="tab-pane fade" id="pills-cake" role="tabpanel" aria-labelledby="pills-cake-tab">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:Constr %>" SelectCommand="SELECT [ProId], [ProName], [Price], [Status], [ImgUrl], [Description], [Quantity] FROM [Product] WHERE ([CategoryId] = @CategoryId) AND ([Status] = 'Available')">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="Cake" Name="CategoryId" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </div>
            </div>
